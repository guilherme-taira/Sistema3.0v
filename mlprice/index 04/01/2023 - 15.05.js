        ...
        // PAGINA DE PRODUTO INIT
            ...
            */
            ...
            <h2 class="accordion-header" id="flush-headingOne">
                <button class="accordion-button collapsed orange" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                Dados do Produto
                </button>
            </h2>
            ...
            <h2 class="accordion-header" id="flush-headingTwo">
                <button class="accordion-button collapsed blue" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
            ...
            <h2 class="accordion-header" id="flush-headingThree">
                <button class="accordion-button collapsed pink" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                Avaliações 
                </button>
            </h2>
            ...
            <input type="submit" class="btn btn-success btn-floating mx-1" value="Entrar">
        ...
        //setTimeout(function(){
            ...
            if(result){
                ...
                `);
                    ...
                    // request data of product
                    const req = async() => {
                        const res = await RequestMLApi(`https://www.mercadolivrehub.embaleme.com.br/api/v1/getDataProduct?idML=${idML}`);
                        console.log(res);
                        return res;
                    } 
    
                    req().then(async data => {
                        const { sold_quantity,empresa,power_seller_status, start_time,price, sale_fee_amount,title, category_id,id,listing_type_id,health,seller_address,attributes,seller_id,BRAND,GTIN, review: {OneStar,TwoStar,ThreeStar,FourStar,FiveStar,reviews}
                    } = data || null;
                   ...
                   // console.log('DATA DO CADASTRO' + dataPeriodo);
                     ...
                     */
                        ...
                        if(today < startTime){
                            // media da quantidade vendida nos ultimos 60 dias
                            const SoldAvg = Math.round(sold_quantity / 60);
                            console.log("CAMPEAO: " + SoldAvg + "  _ "  + title);
                ...
                <div class="accordion-body">Placeholder content for this accordion, which is intended to demonstrate the <code>.accordion-flush</code> class. This is the third item's accordion body. Nothing more exciting happening here in terms of content, but just filling up the space to make it look, at least at first glance, a bit more representative of how this would look in a real-world application.</div>
                                        ...
                                        <div class='content-campeao'>
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <p class="card-text">Anúncio: ${power_seller_status} / Saúde ${health}%</p>
                                                <p class="card-text">Tarifa: ${sale_fee_amount} R$</p>
                                                <p class="card-text">Vendedor: ${empresa}  - Tipo:  ${listing_type_id}</p>
                                                <p class="card-text>Vendedor: ${empresa}, Tipo:${listing_type_id}</p>
                                                <p class="card-text>Marca: ${BRAND}, GTIN:${GTIN}</p>
