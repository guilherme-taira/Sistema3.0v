...
<body>
  <div class="container">
    <div class="row align-items-start">
      <div class="col">
        <form action="lista_correio.php" method="POST">
          <?php
          $banco = new Banco();
          $data = date('Y-m-d');
          $statemente = $banco->pdo->query("SELECT count(cod) as caixa FROM `codigo` WHERE Tipo = 'ML' and datas like '%$data%'");
      ...
      <div class="col">
        ...
        $data = $_SESSION['datahora'];
        $funcionario = $_SESSION['colaborador'];
        include_once "select_correio.php";
