        ...
        <div class="row">
            ...
            <script>
                ...
                addEventListener('load', function() {
                    createProgressbar('progressbar1', '180s');
                });
            </script>
            <?php
            ...
            echo "<div class='container'><div class='row align-items-start'><h1> <span class='badge bg-danger'>Produtos Atualizado Recentes Tray </span> <span class='badge bg-success'>INTERVALO : 2 MIN </span> 
            ...
            echo "<div id='progressbar1' class='progress-bar progress-bar-striped bg-success' role='progressbar'></div>";
                ...
                /**
                 * 
                 *  ATUALIZA PRODUTOS E PROMOÇÃO TRAY HUB EMBALEME
                 * 
                 */

                include_once 'TrayEmbalemePutProduto.php';
                include_once '../conexao_pdo.php';
                $atualizador = new UpdateTrayDadosProduto($pdo2);
                $atualizador->AtualizaProduto();
