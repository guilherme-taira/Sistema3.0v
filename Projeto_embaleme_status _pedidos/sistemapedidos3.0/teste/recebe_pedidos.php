    ...
    <div class="row">
      ...
      foreach ($jsonDecodificado->retorno->pedidos as $pedido) {
        ...
        foreach ($pedido as $produtos) {
          ...
          $numeroPedidoLoja = $pedido->pedido->numeroPedidoLoja;
          echo "NUMERO PEDIDO" . $pedido->pedido->numeroPedidoLoja;
          ...
          if (count($count) > 0) {
            ...
            foreach ($produtos->itens as $lista) {
              ...
              try {
                ...
                $sql = "INSERT INTO pedidos (n_pedido,cod_prod,descricao,quantidade,peso,EAN,dataSaida,frete,cpf,codigoRastreamento,valor_total,valor_produto, marketplace,numeropedidoloja)";
                $sql_values = " VALUES (:n_pedido, :cod_prod, :descricao, :quantidade, :peso, :EAN, :datasaida, :frete, :cpf, :codigoRastreamento, :valor_total,:valor_produto,:marketplace,:numeropedidoloja)";
                ...
                $statement->bindValue('numeropedidoloja', (string) $numeroPedidoLoja, PDO::PARAM_STR);
                $statement->execute();
                $pdo->commit();
