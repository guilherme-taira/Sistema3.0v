...
<head>
	...
	<title>Sistema de Pedidos Embaleme Tablet</title>
...
Fixed Navigation
==================================== -->
	<section class="header navigation" style="background-color: #41BBEA;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg" >
						<a class="navbar-brand" style="color: #000;" href="index.php">
                             Sistema Pedidos TABLET
						</a>
						...
						<div class="collapse navbar-collapse" id="navigation">
							<ul class="navbar-nav ml-auto">
								<li class="nav-item dropdown active list-unstyled">
									<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
										data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<strong><i class="bi bi-journal-plus">&nbsp;</i>Cadastrar</strong>
									</a>
									<div class="dropdown-menu" aria-labelledby="navbarDropdown" style="color:#fff;">
										<a class="dropdown-item" href="pedidos.php"><i class="bi bi-card-checklist"></i> &nbsp; Pegar Pedidos</a>
										<a class="dropdown-item" href="pedidos_fechado.php"><i class="bi bi-box2"></i> &nbsp;Finalizar Pedido</a>
										<a class="dropdown-item" href="cadastra_nota_fiscal.php"><i class="bi bi-file-earmark-medical"></i> &nbsp;Cadastrar Nova Fiscal</a>
										<a class="dropdown-item" href="ConnectHub/recebe_pedidos.php"><i class="bi bi-arrow-down-up"></i> &nbsp;Recebe Pedidos Bling</a>
										<a class="dropdown-item" href="seleciona_colaborador_devolucao.php"><i class="bi bi-arrow-down-up"></i> &nbsp;Devoluções</a>
									</div>
								</li>
								<li class="nav-item list-unstyled">
									<a class="nav-link" href="telaPendencia.php" style="color:#fff;"><i class="bi bi-receipt-cutoff" >&nbsp;</i>Pendências</a>
								</li>
								<li class="nav-item dropdown list-unstyled">
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown" style="color:#fff;">
										<a class="dropdown-item" href="pesquisa.php"> <i class="bi bi-search"></i> &nbsp;Status da Nota Fiscal</a>
										<a class="dropdown-item" href="produtividadelive.php"> <i class="bi bi-eye"></i> &nbsp;Produtividade</a>
									</div>
									<li class="nav-item dropdown active list-unstyled">
									<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
										data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<strong><i class="bi bi-basket3-fill"></i> &nbsp; Balança</strong>
									</a>
									<div class="dropdown-menu" aria-labelledby="navbarDropdown" style="color:#fff;">
										<a class="dropdown-item" href="mandae.php"><i class="bi bi-box2"></i> &nbsp;Mandaê</a>
										<a class="dropdown-item" href="mercado_livre.php"><i class="bi bi-box2"></i> &nbsp;Mercado Livre</a>
										<a class="dropdown-item" href="correio.php"><i class="bi bi-box2"></i> &nbsp;Correios</a>
										<a class="dropdown-item" href="Uello.php"><i class="bi bi-box2"></i> &nbsp;Uello</a>
										<a class="dropdown-item" href="Shopee.php"><i class="bi bi-box2"></i> &nbsp;Shopee Express</a>
										<a class="dropdown-item" href="is_transporte.php"><i class="bi bi-box2"></i> &nbsp;IS Transportadora</a>
									</div>
								</li>
								</li>
							</ul>
...
=====================================-->
	...
	<!-- VERIFICA STATUS DE VOLTA -->
	<script src="js/VoltaAjax.js"></script>
	<!-- VERIFICA STATUS DE SAIDA -->
	<script src="js/SaidaAjax.js"></script>
	<!-- CDN JQUERY -->
	<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
	<!-- BUSCA STATUS DA NOTA FISCAL NO BANCO --> 
	<script src="js/pesquisaStatus.js"></script>
	<!-- Main jQuery -->
