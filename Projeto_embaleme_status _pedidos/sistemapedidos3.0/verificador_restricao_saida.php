    ...
    if ($result->num_rows > 0) {
      ...
      if ($result->num_rows > 0) {
        ...
        if (is_numeric($this->codigo)) {
          ...
          $sql = "SELECT * FROM pedidos where n_pedido = '$this->n_pedido'";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
          ...
          echo "
            ...
            <hr>
            <p class='mb-0'><strong>{$this->codigo}</strong>.</p>
          </div>";
          ...
          Error: Número de Pedido Inexistente, Integre ou Verifique na Bling se o mesmo Existe!  <input type='button' value='Integrar' onclick='abrirIntegracao();'> <br>
        </div>";
            return false;
          }
...
<body>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $(".loader").delay(2000).fadeOut("slow"); //retire o delay quando for copiar!
